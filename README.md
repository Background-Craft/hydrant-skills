...
- [`ship`](./skills/ship/SKILL.md): takes one reviewed issue through the pull request, the CI gate at the exact head, merge, your profile's release steps and the done status, only under a grant you confirm for that issue.
